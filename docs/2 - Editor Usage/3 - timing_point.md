...
**_Uninherited Timing Point(상속되지 않은 타이밍 포인트)_** 는 아래 사진과 같이 타임라인에서 <span style="color: red;">빨간색 선</span>으로 표시됩니다. 
...
**_Inherited Timing Point(상속된 타이밍 포인트)_** 는 아래 사진과 같이 타임라인에서 <span style="color: green;">초록색 선</span>으로 표시됩니다. 
