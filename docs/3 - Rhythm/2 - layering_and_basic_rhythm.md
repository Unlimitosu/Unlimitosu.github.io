...
만약 두 번째 영상에서 중간 부분인 `01:16:568 (2,3,1,1,2,3,4,5) - `에서 드럼을 반영하지 않았다면 인세인이라는 난이도를 생각했을 때, 보컬 없이 배경음과 드럼만 나오기 때문에 리듬이 많이 비어보일 수 있습니다. 이런 부분들은 곡의 난이도에 따라서 유동적으로 낮은 우선 순위의 레이어에 액티브 리듬을 사용하는 것입니다. 이런 부분들은 매퍼의 취향에 따라 패시브 리듬을 사용하는 등 차이가 있을 수 있습니다. 
