...
**레이어링(layering, 또는 우선 순위)** 란, 곡의 구성 요소(보컬, 드럼, 배경음 등)에서 어떤 것을 우선으로 리듬을 잡을지에 대한 추상적인 개념입니다. 레이어링가 없다면 리듬이 곡의 구성 요소를 랜덤하게 따라갈 수 있으며, 이는 곧 맵의 구조가 약함은 물론, 플레이어가 곡을 '연주하고 있다'는 느낌이 들기 어렵게 됩니다. 
...
- **가장 인상 깊은 하나의 구성 요소를 선택**한 후, 그 구간에서 이를 **액티브 리듬**으로 매핑
